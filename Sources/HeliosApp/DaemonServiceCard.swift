    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            if client.state == .connected {
                Text(client.fanState == .system ? "Heartbeat active · No Helios override" : "Heartbeat active")
            ...
            .accessibilityLabel(service.busy ? "Updating helper registration" : "Helper registration actions")
        }
        .padding(12)
